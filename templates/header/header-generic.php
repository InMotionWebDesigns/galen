...
<header id="masthead" class="<?php echo basename( __FILE__, '.php' ); ?>" role="banner" <?php BoldGrid_Framework_Schema::header( true ); ?>>
	...
	<style id='boldgrid-override-styles-manual' type='text/css'> @media only screen and (min-width: 768px) and (max-width:992) { .primary-menu ul li a { font-size: 8px; position:relative; bottom:8px; } } </style>
		...
		<div class='boldgrid-section'>
			<div class="bgtfw <?php echo $configs['template']['pages']['global']['header']; ?>">
				...
				<div class='row header-6 header-7'>
					<div class='col-md-3 header-6'><?php do_action( 'boldgrid-theme-location', 'header', '6' ); ?></div>
					<div class='col-md-9 header-7'><?php do_action( 'boldgrid-theme-location', 'header', '7' ); ?></div>
				</div>
				<div class='row header-8'>
					<div class='col-md-12 header-8'><?php do_action( 'boldgrid-theme-location', 'header', '8' ); ?></div>
				</div>
				<div class='row header-9 header-10'>
					<div class='col-sm-3 col-md-3 header-9'><?php do_action( 'boldgrid-theme-location', 'header', '9' ); ?></div>
					<div class='col-sm-9 col-md-9 header-10'><?php do_action( 'boldgrid-theme-location', 'header', '10' ); ?></div>
				</div>
